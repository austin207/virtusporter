  ...
  return (
    <section className="relative pt-24 pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-20 left-20 w-64 h-64 rounded-full bg-virtus-primary opacity-5 animate-float"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 rounded-full bg-virtus-secondary opacity-5 animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
