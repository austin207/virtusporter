            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">virtusco.tech@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 73568 44578</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600"> Thripunithara, Kerala, India</p>
                </div>
              </div>
            </div>
            
            <div className="flex space-x-4">
              <a href="https://x.com/VirtuscoTech" target="_blank" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-virtus-primary hover:text-white transition-colors">
              <XIcon className="h-5 w-5" />
              </a>
              <a href="https://github.com/VirtusCo" target="_blank" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-virtus-primary hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/virtusco/" target="_blank" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-virtus-primary hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
