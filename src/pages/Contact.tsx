                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@virtusco.com" className="text-virtus-primary hover:underline">info@virtusco.com</a>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="tel:+919876543210" className="text-virtus-primary hover:underline">+91 987 654 3210</a>
                        <p className="text-gray-600 mb-1 mt-2">Corporate Office:</p>
                        <a href="tel:+919876543211" className="text-virtus-primary hover:underline">+91 987 654 3211</a>
                      </div>
                    </div>
